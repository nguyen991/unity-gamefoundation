...
using GameFoundation.Mobile.Notification.Android;
#elif UNITY_IOS
using GameFoundation.Mobile.Notification.iOS;
#endif
using UnityEngine;
using GameFoundation.Utilities;

namespace GameFoundation.Mobile.Notification
{
    /// <summary>
    /// Global notifications manager that serves as a wrapper for multiple platforms' notification systems.
    /// </summary>
    public class GameNotificationsManager : SingletonBehaviour<GameNotificationsManager>
    {
