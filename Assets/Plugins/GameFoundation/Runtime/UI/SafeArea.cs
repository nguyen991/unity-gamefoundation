...
namespace GameFoundation.UI
{
    public class SafeArea : MonoBehaviour
    {
        ...
        [SerializeField] private Vector2 OffsetLeftBottom = new Vector2(0, 0);
        [SerializeField] private Vector2 OffsetRightTop = new Vector2(0, 0);
        ...
        private Rect GetSafeArea()
        {
            ...
            {
                safeArea.xMin += OffsetLeftBottom.x;
                safeArea.yMin += OffsetLeftBottom.y;
                safeArea.xMax += OffsetRightTop.x;
                safeArea.yMax += OffsetRightTop.y;
            }
